 ...
 */
export declare const defaultMainModule: {
    slice: "main";
    reducer: (state?: any) => Reducer;
    metaReducers: never[];
    dependencies: {};
};
/**
 ...
 */
declare function isAction(action: any): boolean;
/**
 ...
 */
declare function isObservable(obj: any): obj is Observable<unknown>;
/**
